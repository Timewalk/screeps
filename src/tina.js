const conf = {
    ...
    spawnDirection: 3,
    route: [
        { r: 'E49S55', x: 39, y: 34 },  // spawn output (index 0)
        { r: 'E49S55', x: 43, y: 34 },  // corridor entry (index 1)
        { r: 'E49S55', x: 43, y: 11 },  // corridor north (index 2)
        { r: 'E49S55', x: 39, y: 11 },  // pickup - adjacent to Hank (index 3)
        { r: 'E49S55', x: 43, y: 11 },  // return corridor north (index 4)
        { r: 'E49S55', x: 43, y: 34 },  // return corridor south (index 5)
        { r: 'E49S55', x: 39, y: 35 },  // dropoff - adjacent to spawn (index 6)
    ],
    pickupIndex: 3,
    dropoffIndex: 6,
};
